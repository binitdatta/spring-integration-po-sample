 ...
 */
@Component
public class ForeignPurchaseOrderProcessor {

	Logger logger = Logger.getLogger(ForeignPurchaseOrderProcessor.class);
    ...
    public void pacePurchaseOrder(VendorPurchaseOrderSummary vpo) throws POException {
    	logger.info("Reached ForeignPurchaseOrderProcessor... placing purchase order");
