...
@Component
public class RateContractPurchaseOrderProcessor {

	Logger logger = Logger.getLogger(RateContractPurchaseOrderProcessor.class);
	   ...
	   @Autowired
	    ...
	    public void pacePurchaseOrder(VendorPurchaseOrderSummary vpo) throws POException {
	    	logger.info("Rate Contract Purchase Order Processor");
